...
// CHANGELOG
//  2024-07-01: Update for SDL3 api changes: SDL_RenderGeometryRaw() uint32
//  version was removed (SDL#9009). 2024-05-14: *BREAKING CHANGE*
...
void ImGui_ImplSDLRenderer3_NewFrame()
{
    ...
    IM_ASSERT(bd != nullptr && "Context or backend not initialized! Did you "
                               "call ImGui_ImplSDLRenderer3_Init()?");
...
static int SDL_RenderGeometryRaw8BitColor(SDL_Renderer*         renderer,
                                          ImVector<SDL_FColor>& colors_out,
                                          SDL_Texture*          texture,
                                          const float*          xy,
                                          int                   xy_stride,
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                SDL_RenderGeometryRaw8BitColor(renderer,
                                               bd->ColorBuffer,
                                               tex,
                                               xy,
