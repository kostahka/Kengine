...
//  2024-07-22: Update for SDL3 api changes: SDL_GetGamepads() memory ownership
//  change. (#7807) 2024-07-18: Update for SDL3 api changes:
//  SDL_GetClipboardText() memory ownership change. (#7801) 2024-07-15: Update
//  for SDL3 api changes: SDL_GetProperty() change to SDL_GetPointerProperty().
//  (#7794) 2024-07-02: Update for SDL3 api changes: SDLK_x renames and
//  SDLK_KP_x removals (#7761, #7762). 2024-07-01: Update for SDL3 api changes:
//  SDL_SetTextInputRect() changed to SDL_SetTextInputArea(). 2024-06-26: Update
//  for SDL3 api changes:
...
static ImGuiKey ImGui_ImplSDL3_KeyEventToImGuiKey(SDL_Keycode  keycode,
...
bool ImGui_ImplSDL3_ProcessEvent(const SDL_Event* event)
{
    ...
    switch (event->type)
    {
        ...
        {
            // IMGUI_DEBUG_LOG("SDL_EVENT_KEY_%d: key=%d, scancode=%d,
            // mod=%X\n", (event->type == SDL_EVENT_KEY_DOWN) ? "DOWN" : "UP",
            // event->key.key, event->key.scancode, event->key.mod);
...
static bool ImGui_ImplSDL3_Init(SDL_Window*   window,
                                SDL_Renderer* renderer,
                                void*         sdl_gl_context)
{
    ImGuiIO& io = ImGui::GetIO();
...
static void ImGui_ImplSDL3_UpdateGamepads()
{
        ...
        bd->GamepadMode != ImGui_ImplSDL3_GamepadMode_Manual)
    {
        ...
        const SDL_JoystickID* sdl_gamepads =
    ...
    ImGui_ImplSDL3_UpdateGamepadAnalog(bd,
                                       io,
                                       ImGuiKey_GamepadR2,
