...
#define ADJUST_VOLUME(type, s, v, ch) ((s) = (type)(((s) * (&(v.x))[(ch)])))
#define ADJUST_VOLUME_U8(s, v, ch)                                             \
    ((s) = (Uint8)(((((s)-128) * (&(v.x))[(ch)])) + 128))
        ...
        switch (format)
        {
            ...
            case SDL_AUDIO_U8:
            {
                ...
                while (len--)
                {
                    channel    = (channel + 1) % 2;
                    src_sample = *src;
                    ADJUST_VOLUME_U8(src_sample, volume, channel);
            ...
            case SDL_AUDIO_S8:
            {
                ...
                while (len--)
                {
                    channel    = (channel + 1) % 2;
                    src_sample = *src8;
                    ADJUST_VOLUME(Sint8, src_sample, volume, channel);
            ...
            case SDL_AUDIO_F32LE:
            {
                ...
                {
                    channel = (channel + 1) % 2;
                    src1    = (SDL_SwapFloatLE(*src32) * (&volume.x)[channel]);
            ...
            case SDL_AUDIO_F32BE:
            {
                ...
                {
                    channel = (channel + 1) % 2;
                    src1    = (SDL_SwapFloatBE(*src32) * (&volume.x)[channel]);
